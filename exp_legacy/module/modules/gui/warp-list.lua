...
local add_new_warp =
    ...
    :on_click(function(player, _)
        ...
        local water_tiles = surface.find_tiles_filtered{ collision_mask = { "water", "water-green", "water-mud", "water-shallow", "water-wube" }, radius = config.standard_proximity_radius + 1, position = position }
